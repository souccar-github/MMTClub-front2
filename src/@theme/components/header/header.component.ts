...
import { NbIconLibraries, NbLayoutDirection, NbLayoutDirectionService, NbMediaBreakpointsService, NbMenuBag, NbMenuService, NbSearchService, NbSidebarService, NbThemeService } from '@nebular/theme';
...
export class HeaderComponent extends AppComponentBase implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.themeService.onThemeChange()
      ...
      .subscribe((data: any) => {
        this.navigateToSubscription(data.term);
      })
  }

  navigateToSubscription(studentId) {
    this._router.navigate(["/app/student-profile/subscription"], {
      queryParams: {
        studentId: studentId,
        isFilter: true
      },
